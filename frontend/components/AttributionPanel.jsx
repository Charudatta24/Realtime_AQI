  ...
  useEffect(() => {
    ...
    const fetchAttribution = async () => {
      ...
      try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE || 'http://localhost:8000'}/api/metrics/attribution?city=${city}&row=${selectedCell.row}&col=${selectedCell.col}${timeParam}`);
